                        ...
                        <div>
                            <div className="md:p-12 md:mx-6">
                                ...
                                <form>
                                    ...
                                    <div className="mb-4">
                                        <label class="text-emerald-50 font-light" for="email">Email or Username</label>
                                        <input type="text" className="backdrop-blur-sm bg-white/30 form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="username" placeholder="Email or Username" />
                                    </div>
                                    <div className="mb-4">
                                        <label class="text-emerald-50 font-light" for="email">Password</label>
                                        <input type="password" className="backdrop-blur-sm bg-white/30 form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="password" placeholder="Password" />
                                    </div>
                                    <div>

                            ...
                            <div className="p-12 mx-12">
                                ...
                                <form>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input type="text" className="backdrop-blur-sm bg-white/30 form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="email" placeholder="Enter your email" />
                                    </div>
                                    <div className="mb-4">
                                        <label className="font-light text-emerald-50" for="email">Username</label>
                                        <input type="text" className="bg-white/30 form-control block w-full m-0 rounded border border-solid border-gray-300  bg-white bg-clip-padding px-3 py-1.5 text-base font-normal text-gray-700 backdrop-blur-sm transition ease-in-out focus:border-blue-600 focus:bg-white focus:text-gray-700 focus:outline-none" id="username" placeholder="Enter your username" />
                                    </div>
                                    <div className="mb-4">

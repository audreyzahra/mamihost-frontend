    ...
    return (
        <>
            <div className="flex max-h-screen flex-row">
                <div className="relative flex w-screen flex-grow basis-2/3 overflow-hidden bg-cover">
                    <img className="flex min-h-screen flex-grow" src="https://images.unsplash.com/photo-1639066648921-82d4500abf1a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8" alt="" />
                </div>
                        ...
                        <div>
                            <div className="md:mx-6 md:p-12">
                                ...
                                <form>
                                    ...
                                    <div className="mb-4">
                                        <label classNameName="font-light text-emerald-50" for="email">Confirm Password</label>
